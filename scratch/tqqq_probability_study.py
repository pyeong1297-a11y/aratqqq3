...
def analyze_tqqq_probabilities_day3_5pct():
    ticker_name = 'TQQQ'
    # TQQQ launched in Feb 2010
    ...
    print(f"\n[분석 완료] TQQQ SMA200 'Day 3 진입' 사이클 수: {total_cycles}회")
...
if __name__ == "__main__":
    analyze_tqqq_probabilities_day3_5pct()
